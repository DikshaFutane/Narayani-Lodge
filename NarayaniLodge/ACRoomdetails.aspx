<%@ Page Title="Room" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="ACRoomdetails.aspx.cs" Inherits="ACRoomdetails" %>
                            ...
                            <table>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>Wifi, Television, Bathroom,AC,...</td>
                                    </tr>
                                </tbody>
                            </table>
                            <p class="f-para">
                                Our AC Room is designed to provide a comfortable and relaxing stay for guests. The room is equipped with a well-maintained air-conditioner, a cozy double bed with fresh linen, and a clean attached bathroom.
                    ...
                    <div class="">
                        ...
                        <div class="row">
                            <div class="col-md-4 place-card">
                                <img src="img/room/a2.jpeg" alt="room" />
                            </div>
                            <div class="col-md-4 place-card">
                                <img src="img/room/a4.jpg" alt="room" />
                            </div>
                            <div class="col-md-4 place-card">
                                <img src="img/room/a7.jpg" alt="room" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="room-booking">
                        ...
                        <div class="booking-form">
                            <asp:HiddenField ID="hfRoomType" runat="server" Value="AC Room" />
